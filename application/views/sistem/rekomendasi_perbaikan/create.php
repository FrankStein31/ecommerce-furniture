  ...
  <div class="col-12">
    <div class="card flat">
      <div class="card-header card-header-blue">
        <span class="card-title">Tambah Rekomendasi Perbaikan</span>
      </div>
      <div class="card-body">
        <form method="post" action="<?= base_url('rekomendasi_perbaikan/create') ?>">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <small class="form-text text-muted">
                  <i class="fa fa-lock"></i> Kode otomatis
                </small>
              </div>
            </div>
            ...
            <div class="col-md-9">
              <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?= set_value('nama_rekomendasi') ?>" 
                       required>
          ...
          <div class="form-group">
            ...
            <textarea name="deskripsi_rekomendasi" 
                      class="form-control" 
                      rows="3" 
                      placeholder="Penjelasan detail mengenai rekomendasi perbaikan ini"><?= set_value('deskripsi_rekomendasi') ?></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea name="solusi_perbaikan" 
                      class="form-control" 
                      rows="4" 
                      placeholder="Langkah-langkah detail untuk melakukan perbaikan..."><?= set_value('solusi_perbaikan') ?></textarea>
          </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="tingkat_prioritas" 
                  ...
                  <option value="rendah" <?= set_select('tingkat_prioritas', 'rendah') ?>>
                    Rendah
                  </option>
                  <option value="sedang" <?= set_select('tingkat_prioritas', 'sedang', true) ?>>
                    Sedang
                  </option>
                  <option value="tinggi" <?= set_select('tingkat_prioritas', 'tinggi') ?>>
                    Tinggi
                  </option>
                </select>
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" 
                       ...
                       class="form-control" 
                       placeholder="0"
                       value="<?= set_value('biaya_estimasi', '0') ?>" 
                       min="0">
                <small class="form-text text-muted">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" 
                       ...
                       class="form-control" 
                       placeholder="0"
                       value="<?= set_value('durasi_perbaikan', '0') ?>" 
                       min="0">
                <small class="form-text text-muted">
