  ...
  <div class="col-12">
    <div class="card flat">
      <div class="card-header card-header-blue">
        <span class="card-title">Tambah Kategori Jenis Perbaikan</span>
      </div>
      <div class="card-body">
        ...
        <form action="<?= base_url('kategori_perbaikan/create') ?>" method="POST" id="form-kategori">
          <div class="row">
            <div class="col-md-9">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" 
                          ...
                          name="deskripsi" 
                          rows="4" 
                          placeholder="Deskripsi singkat tentang kategori ini..."><?= set_value('deskripsi') ?></textarea>
