  ...
  <div class="col-12">
    <div class="card flat">
      <div class="card-header card-header-blue">
        <span class="card-title">Tambah Jenis Perbaikan</span>
      </div>
      <div class="card-body">
        <form method="post" action="<?= base_url('jenis_perbaikan/create') ?>">
          ...
          <div class="form-group">
            ...
            <select name="id_kategori" class="form-control <?= form_error('id_kategori') ? 'is-invalid' : '' ?>" required>
              ...
              <?php foreach($kategori_list as $id => $nama): ?>
                <option value="<?= $id ?>" <?= set_select('id_kategori', $id) ?>>
                  <?= $nama ?>
                </option>
              <?php endforeach; ?>
            </select>
          ...
          <div class="form-group">
            ...
            <input type="text" 
                   ...
                   value="<?= set_value('nama_jenis_perbaikan') ?>" 
                   required>
            ...
            <?php endif; ?>
            <small class="form-text text-muted">Masukkan nama jenis perbaikan furniture</small>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea name="deskripsi" 
                      ...
                      rows="4" 
                      placeholder="Deskripsi atau keterangan tambahan (opsional)"><?= set_value('deskripsi') ?></textarea>
